...
public abstract class PictureData {
    ...
    */
    ...
    static {
    	PictureData.setImagePainter(Picture.PICT, new VectorPainter());
    	PictureData.setImagePainter(Picture.WMF, new VectorPainter());
    	 PictureData.setImagePainter(Picture.EMF, new VectorPainter());
