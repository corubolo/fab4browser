...
/**
 * A simple behavoiur to ask passwords interactively to the end users. Creates a Swing dialog.
 * @author fabio
 * 
 */
public class PasswordBehaviour extends Behavior {

	public static final String MSG_ASK_PASS = "wws_ask_pass";
	public static final String MSG_RET_PASS = "wws_ret_pass";

	/*
	 * (non-Javadoc)
	 * 
	 * @see multivalent.Behavior#semanticEventBefore(multivalent.SemanticEvent,
	 * java.lang.String)
	 */
	@Override
	...
	class PassDialog extends JDialog implements ActionListener, KeyListener {
		...
		public void init() {
			JLabel l = new JLabel(
			"The annotation server needs your password.\n Please enter the password:");
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e != null && e.getActionCommand().equals("Cancel")) {
				...
				pb.getBrowser().eventq(PasswordBehaviour.MSG_RET_PASS, pass);
			setVisible(false);
			fi = null;
			pass = null;
		}
