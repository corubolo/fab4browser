 ...
 * 
 */
public class PageLayoutTag extends StyleTag {
	...
	public void init(BasicContentHandler ac) {
		super.init(ac);
		if (PageLayoutTag.startMethods == null) {
			MethodName [][] m = initMethods(getClass(), true);
			PageLayoutTag.startMethods = m[0];PageLayoutTag.contentMethods = m[1];PageLayoutTag.endMethods = m[2];
		}
	}
	...
	public MethodName[] getContentMethods() {
		return PageLayoutTag.contentMethods;
	}
	@Override
	public MethodName[] getEndMethods() {
		return PageLayoutTag.endMethods;
	}
	@Override
	public MethodName[] getStartMethods() {
		return PageLayoutTag.startMethods;
	}
	...
	public void s_style_page__layout() {
		Attributes att = bc.getAttr();
		printAttr(att);
		s.name = att.getValue("style:name");
		s.type = Style.PAGE;
		s.pageUsage= att.getValue("style:page-usage");
	}
	...
	public void e_style_page__layout() {
