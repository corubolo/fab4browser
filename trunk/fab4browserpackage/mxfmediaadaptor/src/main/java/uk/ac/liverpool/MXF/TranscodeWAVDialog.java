...
public class TranscodeWAVDialog extends JDialog {
    
	private static final long serialVersionUID = 5129990582121411445L;
	...
	public TranscodeWAVDialog(JFrame parent, int minFrame, int maxFrame) {
	...
	public static void main(String[] args) {
		TranscodeWAVDialog f = new TranscodeWAVDialog(new JFrame(), 0, 5/*1500*/);
		f.setVisible(true);
		
		if (f.getRes()) {
			System.out.println(f.getDirectory() + " " + f.getMax() +   " " + f.getMin());
		}
