...
public class LibJPEGLLJVMReaderSPI extends ImageReaderSpi {
	private static final String version = "v8.0";
	private static final String name = "Libjpeg-lljvm0.2-compiled-fab4";
	...
	public LibJPEGLLJVMReaderSPI() {
		super(name,version,names, suffixes,mimeTypes, "LibJpegDecoder", STANDARD_INPUT_TYPE,
