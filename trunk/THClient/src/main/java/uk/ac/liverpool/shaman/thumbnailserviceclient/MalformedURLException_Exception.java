 ...
 * 
 */
@WebFault(name = "MalformedURLException", targetNamespace = "http://shaman.liv.ac.uk/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: uk.ac.liverpool.shaman.thumbnailserviceclient.MalformedURLException
     */
